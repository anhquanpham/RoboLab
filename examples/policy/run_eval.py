...
parser.add_argument("--policy",
                    choices=["pi0", "pi0_fast", "paligemma", "paligemma_fast", "pi05", "pi0_jointvel", "pi0_fast_jointvel", "pi05_jointvel", "gr00t", "dreamzero", "molmo", "openvla", "openvla_oft"], default="pi05",
